...
from dataset import ModelNet, ShapeNetPart
...
def main():
    ...
    parser.add_argument(
        "--model", type=str, default="pointnet", help="Model architecture to be used"
    )
    ...
    parser.add_argument(
        ...
        type=float,
        default=0.001,
        help="Learning Rate (default:0.1 if use_sgd  else 0.001",
    )
    parser.add_argument(
